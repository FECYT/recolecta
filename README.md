...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/FECYT/recolecta@1.0/recolecta-widget.css">

<div data-recolecta-widget></div>

<script src="https://cdn.jsdelivr.net/gh/FECYT/recolecta@1.0/recolecta-widget.js"></script>
```
...
<script src="https://cdn.jsdelivr.net/gh/franciscosoltel/FECYT/recolecta@1.0/recolecta-widget.js"></script>
```
...
```html
https://cdn.jsdelivr.net/gh/FECYT/recolecta@1.0/recolecta-widget.js
```
...
```
https://purge.jsdelivr.net/gh/FECYT/recolecta@1.0/recolecta-widget.js
https://purge.jsdelivr.net/gh/FECYT/recolecta@1.0/recolecta-widget.css
```
