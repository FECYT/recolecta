...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/FECYT/recolecta@1.2/recolecta-widget.css">

<div data-recolecta-widget></div>

<script src="https://cdn.jsdelivr.net/gh/FECYT/recolecta@1.2/recolecta-widget.js"></script>
```
...
```html
https://cdn.jsdelivr.net/gh/FECYT/recolecta@1.2/recolecta-widget.js
```
...
```
https://purge.jsdelivr.net/gh/FECYT/recolecta@1.2/recolecta-widget.js
https://purge.jsdelivr.net/gh/FECYT/recolecta@1.2/recolecta-widget.css
```
